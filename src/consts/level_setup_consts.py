...
class LevelSetupConsts:
    ...
    SCRIPTED_PLAYER_INPUT_FOR_TESTING: dict[int, list[str]] = {
        ...
        400: [HardwareInputConsts.KEYBOARD_KEYUP_ARROW_RIGHT , HardwareInputConsts.KEYBOARD_KEYDOWN_ARROW_DOWN ],
        500: [HardwareInputConsts.KEYBOARD_KEYUP_ARROW_UP, HardwareInputConsts.KEYBOARD_KEYDOWN_4],
