...
from src.world_state._casting_system import SpellCastingData, CastingBehavior, Controls
from src.world_state._combat_system import SpellCombatData, CombatBehavior
from src.world_state._movement_system import SpellMovementData, MovementBehavior
from src.world_state._targeting_system import SpellTargetingData, TargetingBehavior, Targeting
from src.world_state._vfx_and_sfx_system import SpellVfxData, SpellVisualTemplate
...
class SpellData:
    ...
    combat_behavior: CombatBehavior = CombatBehavior.NONE
    ...
    def to_combat_data(self) -> SpellCombatData:
        return SpellCombatData(
            power=self.power,
            flags=self.combat_behavior,
            hp=self.hp,
        )
