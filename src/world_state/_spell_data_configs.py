...
from src.world_state._casting_system import CastingBehavior, Controls, KeyPresses
from src.world_state._combat_system import CombatBehavior
from src.world_state._movement_system import MovementBehavior
from src.world_state._targeting_system import TargetingBehavior, Targeting
    ...
    def get_all_spells() -> list[SpellData]:
        ...
        return [
            ...
            SpellData(
                ...
                combat_behavior=CombatBehavior.HEALING,
            ...
            SpellData(
                ...
                movement_behavior=MovementBehavior.DESPAWN_SELF,
                combat_behavior=CombatBehavior.DAMAGING,
                targeting_behavior=TargetingBehavior.DESPAWN_SELF,
                power=150.0,
                range_limit=0.1
            ),
